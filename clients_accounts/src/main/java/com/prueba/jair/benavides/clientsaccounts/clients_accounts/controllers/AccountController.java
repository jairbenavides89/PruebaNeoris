...
import com.prueba.jair.benavides.clientsaccounts.clients_accounts.services.AccountService;
...
public class AccountController {
    ...
    public ResponseEntity<?> update(@Valid @RequestBody Account account, BindingResult result, @PathVariable Long accountId){
        if (result.hasFieldErrors()) {
            return validation(result);
        }
